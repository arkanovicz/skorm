...
// the client lends and restitutes, hence the mutable half
val exampleDatabase = MutableExampleDatabase(ApiClient("${window.location.origin}/api"))
val bookshelf = MutableExampleDatabase.bookshelf
    ...
    window.onload = {
        ...
        sel(".lend-form").submit { event ->
            ...
            GlobalScope.launch {
                ...
                val book = MutableBook.fetch(bookId) ?: throw Error("invalid book id")
