...
abstract class GenerateObjectsCodeTask : DefaultTask() {
    ...
    @get:OutputFile
    abstract val destStructureFile: RegularFileProperty
    ...
    fun generateObjectsCode() {
        ...
        logger.lifecycle("$tag destStructureFile is: ${destStructureFile.orNull}")
        ...
        val writer = FileWriter(destStructureFile.get().asFile)
        val template = engine.getTemplate("templates/skorm-objects.vtl") ?: throw RuntimeException("template not found")
